...
function renderDay(day) {
    ...
    let html = '<div class="exercise-list"><div class="section-label">EJERCICIOS PRINCIPALES</div>';
            ...
            <div class="exercise-details">
                <div class="exercise-body">
                    ...
                    <div class="sets-header">
                        <div class="header-cell">Serie</div>
                        <div class="header-cell">Peso (kg)</div>
                    ...
                    <div class="sets-container">
                        ${Array.from({length: ex.sets}, (_, i) => `
                            <div class="set-row">
                                ...
                                <input type="number" 
                                       class="set-input" 
                                       placeholder="${ex.reps === 'Al fallo' ? '—' : 'Peso'}"
                                       data-exercise="${exId}"
                                       data-set="${i + 1}"
                                       data-field="weight"
                                ...
                                <input type="number" 
                                       class="set-input" 
                                       placeholder="${ex.reps === 'Al fallo' ? 'Max' : 'Reps'}"
                                       data-exercise="${exId}"
                                       data-set="${i + 1}"
                                       data-field="reps"
                                       onchange="handleSetInput(this)">
