const warmupData = {
    sections: [
        {
            title: "Movilidad Articular (3 min)",
            exercises: [
                "Círculos de brazos: 10 cada dirección",
                "Rotaciones de cadera: 10 cada dirección",
                "Rotaciones de tobillos y muñecas: 10 c/u",
                "Cat-Cow (gato-vaca): 10 repeticiones"
            ]
        },
        {
            title: "Cardio Ligero (4 min - Repetir circuito 2 veces)",
            exercises: [
                "Jumping jacks: 30 segundos",
                "High knees (rodillas altas): 30 seg",
                "Butt kicks (talones a glúteos): 30 seg",
                "Marcha en el lugar: 30 segundos"
            ]
        },
        {
            title: "Activación Muscular (3 min)",
            exercises: [
